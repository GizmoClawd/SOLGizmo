...
async function managePositions() {
  for (let i = POSITIONS.length - 1; i >= 0; i--) {
    ...
    if (!pos.dcaAdded && pos.dcaSize > 0.02) {
      ...
      if (goodDip && momentumOk && pos.dcaCycles >= 2 && (!pos.sl || mc > pos.sl)) {if (goodDip && momentumOk && pos.dcaCycles >= 2) { momentumOk if (goodDip && momentumOk && pos.dcaCycles >= 2) {if (goodDip && momentumOk && pos.dcaCycles >= 2) { pos.dcaCycles >= 2 && (!pos.sl || mc > pos.sl)) {
